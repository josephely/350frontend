...
getQuestions((questionData) => {
    ...
    for (let x in questionData) {
        //console.log(data[x].suggestionbody);
        text = text + '<div class="mb-3"><label for="emailInput" class="form-label">' + questionData[x].surveyquestions + '</label><input type="text" class="form-control" placeholder="your answer">';
    }
